...
if __name__ == '__main__':
    ...
    sce.pp.harmony_integrate(adata, 'Run')
    ...
    sc.tl.leiden(adata, resolution=0.0001, partition_type=la.CPMVertexPartition, key_added='leiden')
    ...
    adata = adata[~adata.obs['leiden'].isin(['17']),:] # Cluster 17 look low quality/doublet
    ...
    adata.write(f'{data}/rat_etx_processed_log.gz.h5ad', compression='gzip')
    print(adata)
    for gene in ['Col1a1',
                 'Epcam',
                 'Ptprc',
